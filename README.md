...
![Экран проектов, тёмная тема](docs/screenshots/dashboard.png)

Светлая тема:

![Экран проектов, светлая тема](docs/screenshots/dashboard_light.png)

### Рабочее пространство

Тёмная тема:

![Рабочее пространство, тёмная тема](docs/screenshots/workspace.png)

Светлая тема:

![Рабочее пространство, светлая тема](docs/screenshots/workspace_light.png)
